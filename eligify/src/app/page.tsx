  ...
  return (
    <main>
      <EligifyHero
        ...
        featureIcons={[
          {
            icon: <FileText className="text-[var(--text-70)] w-8 h-8" />,
            label: "Policy PDFs",
            position: { x: "10%", y: "20%" },
          },
          {
            icon: <Brain className="text-[var(--text-70)] w-8 h-8" />,
            label: "AI Logic",
            position: { x: "15%", y: "60%" },
          },
          {
            icon: <CheckCircle className="text-[var(--text-70)] w-8 h-8" />,
            label: "Instant Result",
            position: { x: "80%", y: "25%" },
          },
          {
            icon: <Users className="text-[var(--text-70)] w-8 h-8" />,
            label: "Citizens",
            position: { x: "75%", y: "65%" },
          },
        ]}
        ...
        brands={[
          {
            ...
            logo: (
              <div className="flex items-center gap-2">
                <Shield className="w-5 h-5 text-[var(--text-40)]" />
                <span className="text-[var(--text-40)] font-semibold text-lg">GovTech</span>
              </div>
            ),
          },
          {
            ...
            logo: (
              <div className="flex items-center gap-2">
                <FileText className="w-5 h-5 text-[var(--text-40)]" />
                <span className="text-[var(--text-40)] font-semibold text-lg">ScholarLink</span>
              </div>
            ),
          },
          {
            ...
            logo: (
              <div className="flex items-center gap-2">
                <Users className="w-5 h-5 text-[var(--text-40)]" />
                <span className="text-[var(--text-40)] font-semibold text-lg">CivicFlow</span>
              </div>
            ),
          },
          {
            ...
            logo: (
              <div className="flex items-center gap-2">
                <Brain className="w-5 h-5 text-[var(--text-40)]" />
                <span className="text-[var(--text-40)] font-semibold text-lg">PolicyAI</span>
              </div>
            ),
          },
        ]}
